            ...
            <View style={[styles.mainContainer, {
                ...
                <ScrollView>
                    <View style={styles.topContainer}>
                        ...
                        <Text style={{ textAlign: "center", fontSize: 20, color: "#000", fontWeight: "500", letterSpacing: 1, }}>My Cart</Text>
                    </View>


                    {product.length == 0 ? (
                        <View style={{ marginTop: 20, justifyContent: "center", alignItems: "center", }}>
                            <Text style={{ marginTop: 20, fontSize: 17, fontWeight: "400", color: theme == "DARK" ? "#fff" : "#000" }}>There are no items in this cart</Text>
                        </View>
                    ) : (
                ...
                {!product.length == 0 ? (
                    <Button
                        ...
                        color='rgb(50,50,50)'>
                        <FontAwesome color="#fff" name="shopping-bag" size={20} />
                        &nbsp;&nbsp;
                        <Text style={{ color: '#fff', fontWeight: 'bold', fontSize: 12 }}>CHECKOUT</Text>
                    </Button>
                ) : null}
